...
%   Armijo-Wolfe-type line search (sufficient decrease), if it is used
%   (see astart above). Has to be in (0,1).
%
...
%   the simpler Backtracking line search should be used instead, unless
%   no line search at all is done (see astart above).
%
